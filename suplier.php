        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <a href="tambah-suplier.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH PELANGGAN</a>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center gap-1">
                          <a href="edit-suplier.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary mr-1">EDIT</a>
                          <a href="hapus-suplier.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                        </td>
                    </tr>
